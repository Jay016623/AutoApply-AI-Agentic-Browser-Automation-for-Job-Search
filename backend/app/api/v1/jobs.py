...
async def search_jobs(
    ...
    return await job_service.search_jobs(db, request, tenant_id=tenant_id)
...
async def list_jobs(
    ...
    return await job_service.list_jobs(db, page, page_size, status, tenant_id=scope_tenant)
...
async def get_job(
    ...
    job = await job_service.get_job(db, job_id, tenant_id=tenant_ctx.tenant_id)
...
async def delete_job(
    ...
    await job_service.delete_job(db, job_id, tenant_id=tenant_ctx.tenant_id)
